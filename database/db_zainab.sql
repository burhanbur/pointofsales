...
--
-- Host: 127.0.0.1
-- Generation Time: 12 Des 2018 pada 16.56
...
--
-- Dumping data untuk tabel `tmst_barang`
--

INSERT INTO `tmst_barang` (`id`, `kode`, `nama`, `harga`, `stok`, `kategori_id`, `foto`, `deskripsi`) VALUES
(1, 'KD00001', 'Hijab Square Kencana Scarf', 50000, 10, 1, '', 'Bahan adem, lebar, nyaman, mudah dibentuk dan lembut');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tmst_pengguna`
--
...
--
-- Dumping data untuk tabel `tmst_pengguna`
--

INSERT INTO `tmst_pengguna` (`id`, `nama`, `password`, `no_telp`, `email`, `provinsi_id`, `kota_id`, `kecamatan_id`, `alamat`, `kode_pos`, `catatan`, `login_terakhir`) VALUES
(1, 'Burhan Mafazi', 'c1a5c76d5d692a72c570ac3dcf1eaf5a', '085695682973', 'burhanmafazi@gmail.com', 32, 3276, 3276040, 'Jl. Ngarai No. 5 Kelapa Dua', '16451', '', '2018-12-12 16:44:08');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tran_konfirmasi`
--

CREATE TABLE `tran_konfirmasi` (
  `id` int(11) NOT NULL,
...
--
-- Struktur dari tabel `tran_login`
--

CREATE TABLE `tran_login` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tran_login`
--

INSERT INTO `tran_login` (`id`, `login_id`, `role_id`) VALUES
(1, 1, 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tran_testimoni`
--

CREATE TABLE `tran_testimoni` (
  `id` int(11) NOT NULL,
...
--
-- Struktur dari tabel `tran_transaksi`
--

CREATE TABLE `tran_transaksi` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tref_bank`
--

INSERT INTO `tref_bank` (`id`, `nama`, `no_rekening`) VALUES
(1, 'Mandiri', '0'),
(2, 'BNI', '0'),
(3, 'BCA', '0'),
(4, 'BRI', '0');
...
--
-- Struktur dari tabel `tref_kategori`
--

CREATE TABLE `tref_kategori` (
  `id` int(11) NOT NULL,
  `nama` varchar(255) NOT NULL,
...
--
-- Dumping data untuk tabel `tref_kategori`
--

INSERT INTO `tref_kategori` (`id`, `nama`, `deskripsi`) VALUES
(1, 'Jilbab', '');
...
--
-- Dumping data untuk tabel `tref_kecamatan`
--

INSERT INTO `tref_kecamatan` (`id`, `kota_id`, `nama`) VALUES
...
--
-- Dumping data untuk tabel `tref_kota`
--

INSERT INTO `tref_kota` (`id`, `provinsi_id`, `nama`) VALUES
...
--
-- Dumping data untuk tabel `tref_provinsi`
--

INSERT INTO `tref_provinsi` (`id`, `nama`) VALUES
(11, 'ACEH'),
(12, 'SUMATERA UTARA'),
(13, 'SUMATERA BARAT'),
(14, 'RIAU'),
...
--
-- Dumping data untuk tabel `tref_role`
--

INSERT INTO `tref_role` (`id`, `role`) VALUES
(1, 'Administrator'),
(2, 'Staff'),
(3, 'User');
...
--
-- Struktur dari tabel `tref_status`
--

CREATE TABLE `tref_status` (
  `id` int(11) NOT NULL,
  `status` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tref_status`
--

INSERT INTO `tref_status` (`id`, `status`) VALUES
...
--
-- Struktur dari tabel `tref_toko`
--

CREATE TABLE `tref_toko` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tref_toko`
--

INSERT INTO `tref_toko` (`id`, `nama`, `alamat`, `telp`, `email`, `facebook`, `twitter`, `instagram`, `line`, `whatsapp`, `image`) VALUES
(1, 'Zainab Project', 'Jakarta', '081322829007', 'zainabproject@gmail.com', NULL, NULL, NULL, NULL, '081322829007', NULL);
...
--
-- Indexes for table `tran_konfirmasi`
--
ALTER TABLE `tran_konfirmasi`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tran_login`
--
ALTER TABLE `tran_login`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tran_testimoni`
--
ALTER TABLE `tran_testimoni`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tran_transaksi`
--
ALTER TABLE `tran_transaksi`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tref_kategori`
--
ALTER TABLE `tref_kategori`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tref_role`
--
ALTER TABLE `tref_role`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_status`
--
ALTER TABLE `tref_status`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_toko`
--
ALTER TABLE `tref_toko`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tmst_barang`
--
ALTER TABLE `tmst_barang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tmst_pengguna`
--
ALTER TABLE `tmst_pengguna`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tran_konfirmasi`
--
ALTER TABLE `tran_konfirmasi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tran_login`
--
ALTER TABLE `tran_login`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tran_testimoni`
--
ALTER TABLE `tran_testimoni`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tran_transaksi`
--
ALTER TABLE `tran_transaksi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tref_kategori`
--
ALTER TABLE `tref_kategori`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tref_role`
--
ALTER TABLE `tref_role`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tref_status`
--
ALTER TABLE `tref_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tref_toko`
--
ALTER TABLE `tref_toko`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
